		...
		<div v-show="showFlag" class="food" ref="food">
			<div class="food-content">
				...
				<div class="content">
					...
					<div class="price">
						<span class="now"><span class="yuan">￥</span>{{food.price}}</span><span class="old" v-show="food.oldPrice"><span class="yuan">￥</span>{{food.oldPrice}}</span>
					</div>
					<div class="cartctrl-wrapper">
						<cartctrl :food="food" @increament="deliver"></cartctrl>
					</div>
				...
				<div class="rating">
					...
					<ratingselect @typechange="changeType" :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="food.ratings"></ratingselect>
